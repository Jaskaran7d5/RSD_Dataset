...
% === Pursuers (Vic Formation) ===
pursuers = {
    % Leader (centered, 500m behind target)
    struct('offset', [-500; 0; 0], 'speed_factor', 0.8),
    % Left Wingman (800m behind, 500m left)
    struct('offset', [-800; -500; 0], 'speed_factor', 0.8),
    % Right Wingman (800m behind, 500m right)
    struct('offset', [-800; +500; 0], 'speed_factor', 0.8)
};
